...
#define HOST "https://8631bd0110a3.ngrok-free.app"
...
void httPost() {
  HTTPClient httPost;
  httPost.begin("https://8631bd0110a3.ngrok-free.app/api/http-post");
...
void httpGet() {
  if (WiFi.status() == WL_CONNECTED) {
    HTTPClient http;
    http.begin("https://8631bd0110a3.ngrok-free.app/api/http-get");
